            ...
            <div className='grid grid-rows-3'>
              ...
              <div className='row-start-2'>
                ...
                <ul>
                  ...
                  <Link href="https://divorcedparents.vercel.app/" target="_blank"><li className='text-white lg:text-2xl xlg:text-2xl font-pressStart text-center py-3 w-screen hover:bg-primary'>Divorced Parents NFT</li></Link>
