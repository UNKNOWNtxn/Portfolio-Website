      ...
      <main className='bg-black h-screen'>
        <div className='flex items-center justify-center h-screen'>
          <ul className='mb-40'>
            ...
            <li className='text-secondary font-pressStart sm:invisible md:visible lg:visible xlg:visible text-center py-3'>Develop Test • Deliver • Dependable</li>
            <li className='text-secondary relative bottom-12 font-pressStart sm:visible md:invisible lg:invisible xlg:invisible text-center py-3'> Develop • Deliver Dependable</li>
          </ul>
        </div>
      </main>
