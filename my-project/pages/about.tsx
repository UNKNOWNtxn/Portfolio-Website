...
const About: NextPage = () => {
    ...
    return (
        ...
        <main className='bg-black sm:h-[175vh] md:bg-cover md:h-screen font-pressStart'>
            ...
            <div className='relative md:top-80 sm:top-48 top-10 flex justify-center leading-loose'>
                ...
                I am a hardworker, fast learner and experienced programmer currently studying computer science. My professional goal is to work with cutting-edge technologies and collaborate with a talented team of developers to create innovative software solutions.<br></br><br></br> Javascript, C++ and Solidity are my most comfortable programming languages, but I am still proficient in a variety of UI frameworks such as TailwindCSS, Bootstrap and more. I have a strong understanding and passion for blockchain technologies including but not limited to; Ethereum, Hardhat and decentralized applications.<br></br><br></br>On my off time I enjoying snowboarding and also playing video games like Overwatch, Call of Duty and Rocket League. Feel free to <Link className='underline underline-offset-1' href='/contact'>contact</Link> me to learn more about my experience, skills and projects, and to discuss potential opportunities.
                </p>
            </div>
        </main>
