    ...
    return (
        ...
        <main className='bg-black sm:h-[175vh] md:bg-cover md:h-screen overflow-y-hidden font-pressStart'>
            ...
            <div className='relative md:top-80 sm:top-48 top-10 flex justify-center leading-loose'>
                <p className='text-primary sm:mb-16 sm:text-sm md:text-base text-xl text-center sm:mx-5 max-w-7xl'>
                I am a hardworker, fast learner and experienced programmer currently studying computer science. My professional goal is to work with cutting-edge technologies and collaborate with a talented team of developers to create innovative software solutions.<br></br><br></br> Javascript, C++ and Solidity are my most comfortable programming languages, but I am still proficient in a variety of UI frameworks such as TailwindCSS, Bootstrap and more. I have a strong understanding and passion for blockchain technologies including but not limited to; Ethereum, Hardhat and decentralized applications.<br></br><br></br>On my off time I enjoying snowboarding and also playing video games like Overwatch, Call of Duty and Rocket League. To learn more about my experience, skills, projects, and to discuss potential opportunities <Link className='underline underline-offset-1' href='/contact'>contact</Link> me.
                </p>
            </div>
        </main>
